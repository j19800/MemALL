...
更新时间：2026-06-26（v3 — 13/13 S0 已全部修复）
基础版本：0.1.13
代码行数：28,057（156 文件）
...
|------|------|--------|------|----|----|----|-----|
| CORE | core/ | 7 | 2,465 | 0 | 7 | 4 | 2 |
| PL | pipeline/ | 40 | 11,528 | 0 | 12 | 6 | 4 |
| MCP | mcp/ | 12 | 4,193 | 0 | 4 | 3 | 1 |
| GW | gateway | 1 | ~2,500 | 0 | 3 | 2 | 1 |
| CLI | cli/ | 7 | 6,800 | 0 | 1 | 2 | 2 |
| TST | tests/ | ~30 | ~3,000 | 0 | 2 | 4 | 0 |
| SRH | search/ | 4 | 401 | 0 | 2 | 1 | 2 |
| GRP | graph/ | 5 | 753 | 0 | 1 | 1 | 1 |
| BRG | bridge/ | 7 | 631 | 0 | 1 | 1 | 0 |
| **合计** | | | **~28,057** | **0** | **33** | **24** | **13** |
