...
```
总负债项：     75（5 S0 + 33 S1 + 24 S2 + 13 S3）
预估修复工时： ~50 小时（S0: 5h + S1: 15h + S2: 5h + S3: 25h）
S0 修复率：    8/13（62%）
上次负债扫描： 2026-06-26
S0 已修复：    S0-002~006, S0-008, S0-010, S0-013 (v0.1.11~v0.1.12)
S0 剩余：      S0-001, S0-007, S0-009, S0-011, S0-012
